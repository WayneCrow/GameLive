...
@class ProgramRoomDataModel;

@interface ProgramRoomModel : NSObject

@property (nonatomic, assign) NSInteger page;
@property (nonatomic, strong) NSArray<ProgramRoomDataModel *> *data;
...
@interface ProgramRoomDataModel : NSObject
