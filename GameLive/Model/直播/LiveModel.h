...
@class LiveRecommendModel,LiveDataModel,LiveLinkObjectModel;

@interface LiveModel : NSObject

@property (nonatomic, strong) LiveRecommendModel *recommend;
@property (nonatomic, strong) NSArray<LiveLinkObjectModel *> *data;
...
@property (nonatomic, strong) LiveLinkObjectModel *link_object;
...
@interface LiveLinkObjectModel : NSObject
